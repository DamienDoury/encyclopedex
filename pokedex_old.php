...
<html lang="fr">
    <head>
		...
		$(document).ready(
			function()
			{
				...
				$("#pokedex").on("mousemove", ".resultat",
					function(event) 
					{
						afficher_infos_survol($(this).attr("id"), event);
					}
				);
				...
				$("#pokedex").on("mouseover", ".resultat",
					function() 
					{
						...
						remplir_info_bulle($(this).attr("id"), $(this).attr("data-forme"));
		...
		{
			nombre_affiches = $("#pokedex > .resultat").length;
			nombre_formes = $("#pokedex > .resultat[data-iteration='first']").length;
			nombre_formes_supplementaires = $("#pokedex > .resultat[data-iteration='']").length;
			nombre_pokemons = nombre_affiches - nombre_formes_supplementaires;
