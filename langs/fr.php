...
<html lang="fr">
    <head>
		...
		<meta name="keywords" content="pokedex, encyclopedex, Pokédex, encyclopédie, Pokémon, pokemon, moteur de recherche, noir, blanc, xy, base de donnees" />
		...
		bdd.push(["Fee","type","18"]);
		bdd.push(["PV","stat","PV"]);
		bdd.push(["PV >= XXX","stat","PV >= XXX"]);
		bdd.push(["PV <= XXX","stat","PV <= XXX"]);
		bdd.push(["PV = XXX","stat","PV = XXX"]);
		...
		bdd.push(["PV = DefSpe","stat","PV = DefSpe"]);
		bdd.push(["PV = Vit","stat","PV = Vit"]);
		bdd.push(["Att","stat","Att"]);
		bdd.push(["Att >= XXX","stat","Att >= XXX"]);
		bdd.push(["Att <= XXX","stat","Att <= XXX"]);
		bdd.push(["Att = XXX","stat","Att = XXX"]);
		...
		bdd.push(["Att = DefSpe","stat","Att = DefSpe"]);
		bdd.push(["Att = Vit","stat","Att = Vit"]);
		bdd.push(["AttSpe","stat","AttSpe"]);
		bdd.push(["AttSpe >= XXX","stat","AttSpe >= XXX"]);
		bdd.push(["AttSpe <= XXX","stat","AttSpe <= XXX"]);
		bdd.push(["AttSpe = XXX","stat","AttSpe = XXX"]);
		...
		bdd.push(["Def = DefSpe","stat","Def = DefSpe"]);
		bdd.push(["Def = Vit","stat","Def = Vit"]);
		bdd.push(["DefSpe","stat","DefSpe"]);
		bdd.push(["DefSpe >= XXX","stat","DefSpe >= XXX"]);
		bdd.push(["DefSpe <= XXX","stat","DefSpe <= XXX"]);
		bdd.push(["DefSpe = XXX","stat","DefSpe = XXX"]);
		...
		bdd.push(["DefSpe = Def","stat","DefSpe = Def"]);
		bdd.push(["DefSpe = Vit","stat","DefSpe = Vit"]);
		bdd.push(["Vit","stat","Vit"]);
		bdd.push(["Vit >= XXX","stat","Vit >= XXX"]);
		bdd.push(["Vit <= XXX","stat","Vit <= XXX"]);
		bdd.push(["Vit = XXX","stat","Vit = XXX"]);
		...
		bdd.push(["Total = XXX","stat","Total = XXX"]);
		bdd.push(["PV+Att","stat","PV+Att"]);
		bdd.push(["PV+Att >= XXX","stat","PV+Att >= XXX"]);
		bdd.push(["PV+Att <= XXX","stat","PV+Att <= XXX"]);
		bdd.push(["PV+Att = XXX","stat","PV+Att = XXX"]);
		bdd.push(["Att+PV","stat","Att+PV"]);
		bdd.push(["Att+PV >= XXX","stat","Att+PV >= XXX"]);
		bdd.push(["Att+PV <= XXX","stat","Att+PV <= XXX"]);
		bdd.push(["Att+PV = XXX","stat","Att+PV = XXX"]);
		bdd.push(["PV+AttSpe","stat","PV+AttSpe"]);
		bdd.push(["PV+AttSpe >= XXX","stat","PV+AttSpe >= XXX"]);
		bdd.push(["PV+AttSpe <= XXX","stat","PV+AttSpe <= XXX"]);
		bdd.push(["PV+AttSpe = XXX","stat","PV+AttSpe = XXX"]);
		bdd.push(["AttSpe+PV","stat","AttSpe+PV"]);
		bdd.push(["AttSpe+PV >= XXX","stat","AttSpe+PV >= XXX"]);
		bdd.push(["AttSpe+PV <= XXX","stat","AttSpe+PV <= XXX"]);
		bdd.push(["AttSpe+PV = XXX","stat","AttSpe+PV = XXX"]);
		bdd.push(["PV+Def","stat","PV+Def"]);
		bdd.push(["PV+Def >= XXX","stat","PV+Def >= XXX"]);
		bdd.push(["PV+Def <= XXX","stat","PV+Def <= XXX"]);
		bdd.push(["PV+Def = XXX","stat","PV+Def = XXX"]);
		bdd.push(["Def+PV","stat","Def+PV"]);
		bdd.push(["Def+PV >= XXX","stat","Def+PV >= XXX"]);
		bdd.push(["Def+PV <= XXX","stat","Def+PV <= XXX"]);
		bdd.push(["Def+PV = XXX","stat","Def+PV = XXX"]);
		bdd.push(["PV+DefSpe","stat","PV+DefSpe"]);
		bdd.push(["PV+DefSpe >= XXX","stat","PV+DefSpe >= XXX"]);
		bdd.push(["PV+DefSpe <= XXX","stat","PV+DefSpe <= XXX"]);
		bdd.push(["PV+DefSpe = XXX","stat","PV+DefSpe = XXX"]);
		bdd.push(["DefSpe+PV","stat","DefSpe+PV"]);
		bdd.push(["DefSpe+PV >= XXX","stat","DefSpe+PV >= XXX"]);
		bdd.push(["DefSpe+PV <= XXX","stat","DefSpe+PV <= XXX"]);
		bdd.push(["DefSpe+PV = XXX","stat","DefSpe+PV = XXX"]);
		bdd.push(["PV+Vit","stat","PV+Vit"]);
		bdd.push(["PV+Vit >= XXX","stat","PV+Vit >= XXX"]);
		bdd.push(["PV+Vit <= XXX","stat","PV+Vit <= XXX"]);
		bdd.push(["PV+Vit = XXX","stat","PV+Vit = XXX"]);
		bdd.push(["Vit+PV","stat","Vit+PV"]);
		bdd.push(["Vit+PV >= XXX","stat","Vit+PV >= XXX"]);
		bdd.push(["Vit+PV <= XXX","stat","Vit+PV <= XXX"]);
		bdd.push(["Vit+PV = XXX","stat","Vit+PV = XXX"]);
		bdd.push(["Att+AttSpe","stat","Att+AttSpe"]);
		bdd.push(["Att+AttSpe >= XXX","stat","Att+AttSpe >= XXX"]);
		bdd.push(["Att+AttSpe <= XXX","stat","Att+AttSpe <= XXX"]);
		bdd.push(["Att+AttSpe = XXX","stat","Att+AttSpe = XXX"]);
		bdd.push(["AttSpe+Att","stat","AttSpe+Att"]);
		bdd.push(["AttSpe+Att >= XXX","stat","AttSpe+Att >= XXX"]);
		bdd.push(["AttSpe+Att <= XXX","stat","AttSpe+Att <= XXX"]);
		bdd.push(["AttSpe+Att = XXX","stat","AttSpe+Att = XXX"]);
		bdd.push(["Att+Def","stat","Att+Def"]);
		bdd.push(["Att+Def >= XXX","stat","Att+Def >= XXX"]);
		bdd.push(["Att+Def <= XXX","stat","Att+Def <= XXX"]);
		bdd.push(["Att+Def = XXX","stat","Att+Def = XXX"]);
		bdd.push(["Def+Att","stat","Def+Att"]);
		bdd.push(["Def+Att >= XXX","stat","Def+Att >= XXX"]);
		bdd.push(["Def+Att <= XXX","stat","Def+Att <= XXX"]);
		bdd.push(["Def+Att = XXX","stat","Def+Att = XXX"]);
		bdd.push(["Att+DefSpe","stat","Att+DefSpe"]);
		bdd.push(["Att+DefSpe >= XXX","stat","Att+DefSpe >= XXX"]);
		bdd.push(["Att+DefSpe <= XXX","stat","Att+DefSpe <= XXX"]);
		bdd.push(["Att+DefSpe = XXX","stat","Att+DefSpe = XXX"]);
		bdd.push(["DefSpe+Att","stat","DefSpe+Att"]);
		bdd.push(["DefSpe+Att >= XXX","stat","DefSpe+Att >= XXX"]);
		bdd.push(["DefSpe+Att <= XXX","stat","DefSpe+Att <= XXX"]);
		bdd.push(["DefSpe+Att = XXX","stat","DefSpe+Att = XXX"]);
		bdd.push(["Att+Vit","stat","Att+Vit"]);
		bdd.push(["Att+Vit >= XXX","stat","Att+Vit >= XXX"]);
		bdd.push(["Att+Vit <= XXX","stat","Att+Vit <= XXX"]);
		bdd.push(["Att+Vit = XXX","stat","Att+Vit = XXX"]);
		bdd.push(["Vit+Att","stat","Vit+Att"]);
		bdd.push(["Vit+Att >= XXX","stat","Vit+Att >= XXX"]);
		bdd.push(["Vit+Att <= XXX","stat","Vit+Att <= XXX"]);
		bdd.push(["Vit+Att = XXX","stat","Vit+Att = XXX"]);
		bdd.push(["Def+DefSpe","stat","Def+DefSpe"]);
		bdd.push(["Def+DefSpe >= XXX","stat","Def+DefSpe >= XXX"]);
		bdd.push(["Def+DefSpe <= XXX","stat","Def+DefSpe <= XXX"]);
		bdd.push(["Def+DefSpe = XXX","stat","Def+DefSpe = XXX"]);
		bdd.push(["DefSpe+Def","stat","DefSpe+Def"]);
		bdd.push(["DefSpe+Def >= XXX","stat","DefSpe+Def >= XXX"]);
		bdd.push(["DefSpe+Def <= XXX","stat","DefSpe+Def <= XXX"]);
		bdd.push(["DefSpe+Def = XXX","stat","DefSpe+Def = XXX"]);
		bdd.push(["Def+Vit","stat","Def+Vit"]);
		bdd.push(["Def+Vit >= XXX","stat","Def+Vit >= XXX"]);
		bdd.push(["Def+Vit <= XXX","stat","Def+Vit <= XXX"]);
		bdd.push(["Def+Vit = XXX","stat","Def+Vit = XXX"]);
		bdd.push(["Vit+Def","stat","Vit+Def"]);
		bdd.push(["Vit+Def >= XXX","stat","Vit+Def >= XXX"]);
		bdd.push(["Vit+Def <= XXX","stat","Vit+Def <= XXX"]);
		bdd.push(["Vit+Def = XXX","stat","Vit+Def = XXX"]);
		bdd.push(["DefSpe+Vit","stat","DefSpe+Vit"]);
		bdd.push(["DefSpe+Vit >= XXX","stat","DefSpe+Vit >= XXX"]);
		bdd.push(["DefSpe+Vit <= XXX","stat","DefSpe+Vit <= XXX"]);
		bdd.push(["DefSpe+Vit = XXX","stat","DefSpe+Vit = XXX"]);
		bdd.push(["Vit+DefSpe","stat","Vit+DefSpe"]);
		bdd.push(["Vit+DefSpe >= XXX","stat","Vit+DefSpe >= XXX"]);
		bdd.push(["Vit+DefSpe <= XXX","stat","Vit+DefSpe <= XXX"]);
		bdd.push(["Vit+DefSpe = XXX","stat","Vit+DefSpe = XXX"]);
		bdd.push(["Att+AttSpe+Vit","stat","Att+AttSpe+Vit"]);
		bdd.push(["Att+AttSpe+Vit >= XXX","stat","Att+AttSpe+Vit >= XXX"]);
		bdd.push(["Att+AttSpe+Vit <= XXX","stat","Att+AttSpe+Vit <= XXX"]);
		bdd.push(["Att+AttSpe+Vit = XXX","stat","Att+AttSpe+Vit = XXX"]);
		bdd.push(["Def+DefSpe+Vit","stat","Def+DefSpe+Vit"]);
		bdd.push(["Def+DefSpe+Vit >= XXX","stat","Def+DefSpe+Vit >= XXX"]);
		bdd.push(["Def+DefSpe+Vit <= XXX","stat","Def+DefSpe+Vit <= XXX"]);
		bdd.push(["Def+DefSpe+Vit = XXX","stat","Def+DefSpe+Vit = XXX"]);
		bdd.push(["PV+Att+AttSpe","stat","PV+Att+AttSpe"]);
		bdd.push(["PV+Att+AttSpe >= XXX","stat","PV+Att+AttSpe >= XXX"]);
		bdd.push(["PV+Att+AttSpe <= XXX","stat","PV+Att+AttSpe <= XXX"]);
		bdd.push(["PV+Att+AttSpe = XXX","stat","PV+Att+AttSpe = XXX"]);
		bdd.push(["PV+Def+DefSpe","stat","PV+Def+DefSpe"]);
		bdd.push(["PV+Def+DefSpe >= XXX","stat","PV+Def+DefSpe >= XXX"]);
		bdd.push(["PV+Def+DefSpe <= XXX","stat","PV+Def+DefSpe <= XXX"]);
		bdd.push(["PV+Def+DefSpe = XXX","stat","PV+Def+DefSpe = XXX"]);
		bdd.push(["PV*Def","stat","PV*Def"]);
		bdd.push(["PV*Def >= XXX","stat","PV*Def >= XXX"]);
		...
		bdd.push(["DefSpe*PV <= XXX","stat","DefSpe*PV <= XXX"]);
		bdd.push(["DefSpe*PV = XXX","stat","DefSpe*PV = XXX"]);
		bdd.push(["Puissance >= XXX","carac_attaque","Puissance >= XXX"]);
		bdd.push(["Puissance <= XXX","carac_attaque","Puissance <= XXX"]);
		bdd.push(["Puissance = XXX","carac_attaque","Puissance = XXX"]);
		bdd.push(["Probabilite >= XXX","carac_attaque","Probabilite >= XXX"]);
		bdd.push(["Probabilite <= XXX","carac_attaque","Probabilite <= XXX"]);
		bdd.push(["Probabilite = XXX","carac_attaque","Probabilite = XXX"]);
		bdd.push(["PP >= XXX","carac_attaque","PP >= XXX"]);
		bdd.push(["PP <= XXX","carac_attaque","PP <= XXX"]);
		bdd.push(["PP = XXX","carac_attaque","PP = XXX"]);
		bdd.push(["Priorite >= XXX","carac_attaque","Priorite >= XXX"]);
		bdd.push(["Priorite <= XXX","carac_attaque","Priorite <= XXX"]);
		bdd.push(["Priorite = XXX","carac_attaque","Priorite = XXX"]);
		...
		$(document).ready(
			function()
			{
				...
				$("#footer").on("click", "input",
					function()
					{
						alert("En cours de d\351veloppement ...");
						return false;
					}
				);
    ...
    <body>			
		...
		<div id="tuto" class="popup">
			<div>
				...
				Le tutoriel dure environ 1 minute.<br />
			...
			<div>
				Voici la barre de recherche.<br />
				C'est avec celle-ci que l'on sélectionne les filtres de recherche.<br />
				<input class="avancer_tuto" type="button" value="Continuer" />
			</div>
			
			<div>
				Vous pouvez utiliser différents filtres parmi les catégories suivantes :<br />
				<br />
				<div class="pokemon">Pokémon</div>
				<div class="numero">Numéro national</div>
				<div class="type">Type</div>
				<div class="capspe">Talent (Capacité spéciale)</div>
			...
			<div>
				Démonstration :<br />
				Tapons la lettre "D" dans la barre de recherche.<br />
			...
			<div>
				Quand un filtre est sélectionné, il apparait en bleu.<br />
				...
				<p>
					...
					3) Sinon, utiliser la touche Entrée sélectionne le premier résultat du menu.<br />
					4) Lorsqu'il n'y a qu'un seul résultat dans le menu, la touche Espace le sélectionnera.<br />
				</p>
				<input class="avancer_tuto" type="button" value="Continuer" />
			</div>
			
			<div>
				Une fois le filtre validé, il apparait au-dessus la barre de recherche.<br />
				Il existe 3 moyens d'effacer un filtre :<br />
				
				<p>
					1) En cliquant dessus.<br />
					2) En utilisant la touche Retour arrière quand la barre de recherche est vide.<br />
					3) Cliquer sur la croix rouge efface tous les filtres.
				</p>
			...
			<div>
				...
				Voici la liste des Pokémon de type Dragon !<br />
				...
				pour accédez à la fiche du premier Pokémon de la liste.<br />
				<input class="avancer_tuto" type="button" value="Continuer" />
			</div>

			<div>
				Vous pouvez combiner les filtres de recherche.<br />
				Par exemple, ajoutons le filtre "Blizzard".<br />
				<input class="avancer_tuto" type="button" value="Continuer" />
			</div>

			<div>
				Nous obtenons la liste des Pok&eacute;mon Dragon apprenant l'attaque Blizzard !<br />
				<input class="avancer_tuto" type="button" value="Continuer" />
			</div>

			<div>
				Ajoutons le filtre "AttSpe" pour trier les r&eacute;sultats par niveau d'Attaque Sp&eacute;ciale.<br />
				<input class="avancer_tuto" type="button" value="Continuer" />
			</div>

			<div>
				On remarque plusieurs choses :<br />
				<p>
					1) Les statistiques sont maintenant affich&eacute;es.<br />
					2) Les r&eacute;sultats sont tri&eacute;s.<br />
					3) Les diff&eacute;rentes formes des Pok&eacute;mons sont trait&eacute;es comme plusieurs r&eacute;sultats<br />
					(On voit ici Kyurem et ses 2 autres formes).<br />
				</p>
				<input class="avancer_tuto" type="button" value="Continuer" />
			</div>
		...
		<div id="header">
			...
			<div id="espace_recherche">
				...
				<div style="margin: 0.5em auto; width: 15em;">
						<div>
							<input id="saisie" type="text" onkeyup="recherche(event);" placeholder="Filtre par type, attaque, stat..." autocomplete="off" autofocus />
						</div>
