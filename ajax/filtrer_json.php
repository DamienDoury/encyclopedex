...
foreach($liste_pokemon AS $pokemon) // On parcourt la liste des Pokemon.
{
	...
	if(sizeof($liste_ordres) > 0 || !in_array($id, $liste_id)) // Permet de n'afficher qu'un seul pokemon par forme sauf lors d'un tri special.
	{
		$liste_id[] = $id;
