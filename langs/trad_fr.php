<?php
define("META_DESCRIPTION", "L'Encyclopedex est le meilleur Pokédex stratégique pour Pokémon Noir 2/Blanc 2 grâce à son moteur de recherche simple, intuitif et performant !");
define("META_KEYWORDS", "pokedex, encyclopedex, Pokédex, encyclopédie, Pokémon, pokemon, moteur de recherche, noir, blanc, xy, base de donnees");
define("SHARE_URL_POPUP", "Enregistrez votre recherche ou partagez-la avec vos amis avec l'URL suivante :");
define("TUTO_YES_YES", "Oui bonne idée !");
define("TUTO_NO_NO", "Non merci, pas besoin.");
define("TUTO_BUTTON_NEXT", "Continuer");
define("TUTO_BUTTON_FINISH", "Fermer le tutoriel");
define("TUTO_PANEL_0", "Bienvenue sur Encyclopedex !<br />
				Voulez-vous apprendre à vous servir du Pokédex ?<br />
				Le tutoriel dure environ 1 minute.<br />");
define("TUTO_PANEL_1", "Voici la barre de recherche.<br />
				C'est avec celle-ci que l'on sélectionne les filtres de recherche.<br />");
define("TUTO_PANEL_2", 'Vous pouvez utiliser différents filtres parmi les catégories suivantes :<br />
				<br />
...
define("TUTO_PANEL_3", 'Démonstration :<br />
...
define("TUTO_PANEL_4", 'Quand un filtre est sélectionné, il apparait en bleu.<br />
...
define("TUTO_PANEL_5", 'Une fois le filtre validé, il apparait au-dessus la barre de recherche.<br />
...
define("TUTO_PANEL_6", 'La liste des Pokémon se met à jour automatiquement.<br />
...
define("TUTO_PANEL_7", 'Vous pouvez combiner les filtres de recherche.<br />
				Par exemple, ajoutons le filtre "Blizzard".<br />');
define("TUTO_PANEL_8", 'Nous obtenons la liste des Pok&eacute;mon Dragon apprenant l\'attaque Blizzard !<br />');
define("TUTO_PANEL_9", 'Ajoutons le filtre "AttSpe" pour trier les r&eacute;sultats par niveau d\'Attaque Sp&eacute;ciale.<br />');
define("TUTO_PANEL_10", 'On remarque plusieurs choses :<br />
				<p>
...
define("TUTO_PANEL_11", "Le tutoriel se termine ici.<br />
...
define("SEARCH_PLACEHOLDER", "Filtre par type, attaque, stat...");
define("COMPARE", "Comparer");
define("BATTLE", "Combattre");
define("ANALYZE", "Analyser");
define("COMING_SOON", "En cours de développement ...");

define("SEARCH_IN_PROGRESS", "Recherche en cours ...");
define("NONE", "Aucun");
define("SINGLE", "seul");
define("RESULT_SINGULAR", "r&eacute;sultat");
define("RESULT_PLURAL", "r&eacute;sultats");
define("FORM_SINGULAR", "forme d&eacute;riv&eacute;e");
define("FORM_PLURAL", "formes d&eacute;riv&eacute;es");

define("IN_CONSTRUCTION", "<b>PAGE EN CONSTRUCTION ...</b><br><em>Cette page sera bient&ocirc;t g&eacute;niale !</em>");
